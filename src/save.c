...
static void save_dimensions(FILE *output, const int nrows, const int ncols) {
  int err = 0;
...
static void save_board_values(FILE *output, const char board[], const int nrows,
                              const int ncols) {
  int err = 0;
  int i = 0;
...
void save_board(FILE *output, const char board[], const int nrows,
                const int ncols) {
